...
print(f"Clase menos frecuente: '{min_label}' con {min_count} muestras")
...
print(final_counts)
print(f"Total de muestras balanceadas: {len(balanced_dataset)}")
...
output_path = os.path.join(output_dir, "twitter_balancedNOCLEAN.csv")
balanced_dataset.to_csv(output_path, index=False)
print(f"Dataset balanceado guardado como: {output_path}")
