...
PATH_INPUT_FILE = os.path.join(project_root, "MODELS", "LogisticRegression", "output.txt")
PATH_OUTPUT_DIR = os.path.join(project_root, "GRAFIQUES", "logreg")
...
def plot_benchmark_results(df, output_path):
    ...
    ax.set_title("Comparativa Accuracy - Logistic Regression", fontsize=18, pad=20, fontweight='bold')
